...
def generate_launch_description():
    ...
    tracker_cfg = os.path.join(share, "config", "tum_vi_room1_tracker_upstream.yaml")
    estimator_cfg = os.path.join(share, "config", "tum_vi_room1_vio_upstream.yaml")
    trajectory_csv = os.environ.get(
        "VIO_TRAJECTORY_CSV", "/tmp/vio_trajectory_upstream.csv")
